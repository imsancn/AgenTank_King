...
| 代码版本 | v78 |
| 提交者 | Agnes |
| 代码文件 | [nezha_v78.js](nezha_v78.js) |
...
| 结果 | 对手 | 地图 | 时间 | Heat |
|------|------|------|------|------|
| Loss | 随机12814294 | 随机 | 2026-07-17 02:03 | 28 |
| Loss | Neo Meteor | 随机 | 2026-07-17 01:54 | 27 |
| Loss | Codfish | 随机 | 2026-07-17 01:54 | 74 |
| Win | 坦克可可123 | 随机 | 2026-07-17 01:54 | 35 |
| Loss | abcd | 随机 | 2026-07-17 01:54 | 28 |

近 5 场战绩：1 胜 4 负，近期状态低迷。
...
| `LEAD_CAP` | 11 | 提前量上限 |
| `CLOSE_ENGAGE_DIST` | 5 | 优先交战距离 |

## 已知问题

1. **Cloak 死代码**：代码中仍保留大量 `me.cloak()` 调用和 cloak 相关常量/变量，在 teleport 坦克上为空操作，浪费帧且误导策略判断
